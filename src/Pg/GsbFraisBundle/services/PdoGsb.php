...
/**
 * Retourne sous forme d'un tableau associatif toutes la liste des tablettes 
 * concernées par les deux arguments
 
 * @param $idTab 
 * @param $idVisiteur
 * @return l'id du visiteur, son nom, son prénom, l'id de la tablette, sa mémoire interne et externe, et son os
*/
    public function getLesTablettes($idTab, $idVisiteur){
        $req = "SELECT id, nom, prenom, idTab, memoireTab, memoireExtTab, osTablette 
        FROM visiteur, tablette 
        WHERE tablette.refVisiteur=visiteur.id 
