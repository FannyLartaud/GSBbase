...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // pg_gsb_frais_listetablette
        if ($pathinfo === '/listetablette') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\ListeTabletteController::listetabletteAction',  '_route' => 'pg_gsb_frais_listetablette',);
        }

        // pg_gsb_frais_affectertablette
        if ($pathinfo === '/affectertablette') {
            return array (  '_controller' => 'PgGsbFraisBundle:AffecterTablette:affectertablette',  '_route' => 'pg_gsb_frais_affectertablette',);
        }
